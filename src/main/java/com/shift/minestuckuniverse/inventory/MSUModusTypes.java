...
public class MSUModusTypes {
    public static Supplier<ModusType<CommunistModus>> ARRAY;
    ...
    public static void register() {
        ARRAY = ModusTypes.REGISTER.register("msuarray", () -> new ModusType<>(CommunistModus::new, MSUItems.ARRAY_MODUS_CARD));
